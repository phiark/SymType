...
The eight Keybr reference screenshots requested by the brief are not present in the initial workspace. Functional inventory and ANSI 101/Symmetric comparison are therefore **Blocked**, not silently waived; they are not pixel-match targets.
