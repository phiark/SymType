...
**Status values:** Verified, In progress, Blocked, Optional, Cancelled

`Class` records release priority. `Status` records the current outcome. There are no unexplained
Pending rows.
...
| V2-SCP-002 | Preserve V1 business results                             | Release Blocker | shared/Web/server literal goldens                       | `npm run test:regression` and final E2E            | Verified    |
| V2-SCP-003 | Preserve user data                                       | Release Blocker | migration, idempotency, settings, export/restore suites | 7 files, 34 tests passed                           | Verified    |
...
| V2-G1-002  | Freeze event and metric outputs                          | Release Blocker | shared, Web, server goldens                             | regression suite                                   | Verified    |
| V2-G1-003  | Freeze modifiers and error policies                      | Release Blocker | Web and shared goldens                                  | regression suite                                   | Verified    |
| V2-G1-004  | Freeze persistence and settings                          | Release Blocker | server literal goldens                                  | integration suites                                 | Verified    |
